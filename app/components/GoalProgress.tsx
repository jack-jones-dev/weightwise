    ...
    return (
        <div className="bg-white rounded-lg p-6 shadow mb-8 border border-gray-300">
            ...
            <div className="flex items-center mb-4">
                <p className="text-black text-base pr-2 whitespace-nowrap">{startWeight} {user.preferredUnits}</p>
                ...
                <p className="text-black text-base pl-2 whitespace-nowrap">{user.goalWeight} {user.preferredUnits}</p>
            </div>
            <p className="text-blue-500 text-2xl font-bold text-center">{remaining} {user.preferredUnits} to go!</p>
        </div>
    )
}
